#pragma once
// AYTilemapComponent.h — CM-3 (2026-08-11): 2D tilemap placement metadata.
//
...
// (mirror of ayt::ay2d::cellToWorld) live in AY2DUvMath.h; the
...
struct TilemapComponent : public IComponent {
    ...
    // entry — keep these macro-only (see MeshComponent.h:6-8).
    ...
    TilemapComponent() {
        ...
        // explicit ctor assignment is required (MeshComponent.h:52-57).
        atlasTilesPerRow    = 1;
