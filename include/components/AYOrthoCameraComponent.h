#pragma once
// AYOrthoCameraComponent.h — CM-3 (2026-08-11): 2D orthographic camera
// metadata + header-only view/projection math.
//
// viewMatrix()/projectionMatrix() mirror ayt::ay2d::OrthographicCamera
// (AYOrthographicCamera.h:116-163) exactly — same origin-centered
...
struct OrthoCameraComponent : public IComponent {
    ...
    // (AYOrthographicCamera.h:116-149). Translate by -position,
    ...
    // (AYOrthographicCamera.h:155-163). Visible region centered on
